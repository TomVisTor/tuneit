...
file = File.open(Rails.root.join('db/seeds/users/italian.jpg'))
italian.photo.attach(io: file, filename: 'italian.png', content_type: 'image/jpg')
italian.save!
...
orgue.photo.attach(io: file, filename: 'orgue.jpg', content_type: 'image/jpg')
orgue.save!
